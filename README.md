# 🛒 Análisis de Ventas de 4 Tiendas · EDA con Python

¡Bienvenido al proyecto de **análisis exploratorio de datos (EDA)** de cuatro tiendas!  
Aquí encontrarás un estudio detallado sobre el rendimiento comercial de cada tienda, basado en un conjunto de datos de ventas con información sobre productos, precios, categorías, calificaciones y costos de envío.

---

## 📌 ¿Qué encontrarás en este repositorio?

Este notebook de Google Colab contiene un análisis completo que responde preguntas clave como:
...
Proyecto desarrollado como parte de un challenge de análisis de datos.  
Si tienes sugerencias o preguntas, ¡no dudes en abrir un **issue** o contribuir!
